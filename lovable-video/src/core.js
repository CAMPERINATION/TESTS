...
(function () {
  ...
  const COL = {
    ...
    sage: '#a9c4a0',
    butter: '#f6d58e',
    coral: '#e8766a', coralDk: '#c85a4f', teal: '#6aa39a', tealDk: '#4f857c', sun: '#f6d58e',
    lilac: '#c9b3d9', lilacDk: '#a48bb8', mint: '#cfe3c6', sky: '#bcd8e6', plum: '#3a2419', plum2: '#5b3a29',
    grey: '#c9bcae', greyDk: '#8d7a6b', green: '#5f9a63', red: '#b8404e', white: '#ffffff',
  };
